...
display = pygame.Surface((300,200)) ; moving_right = False ; moving_left = False ; vertical_momentum = 0 ; air_timer = 0 ; true_scroll = [0,0] ; CHUNK_SIZE = 15
...
pygame.mixer.music.load('C:/Users/user/Documents/PyGameFolder/music.wav')
